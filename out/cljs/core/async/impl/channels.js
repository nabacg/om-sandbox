...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11848 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11848 = (function (val,box,meta11849){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11848.cljs$lang$type = true;
cljs.core.async.impl.channels.t11848.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11848";
cljs.core.async.impl.channels.t11848.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t11848");
});
cljs.core.async.impl.channels.t11848.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11848.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11850){var self__ = this;
var _11850__$1 = this;return self__.meta11849;
});
cljs.core.async.impl.channels.t11848.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11850,meta11849__$1){var self__ = this;
var _11850__$1 = this;return (new cljs.core.async.impl.channels.t11848(self__.val,self__.box,meta11849__$1));
});
cljs.core.async.impl.channels.__GT_t11848 = (function __GT_t11848(val__$1,box__$1,meta11849){return (new cljs.core.async.impl.channels.t11848(val__$1,box__$1,meta11849));
});
}
return (new cljs.core.async.impl.channels.t11848(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11851 = self__.takes.pop();if((taker_11851 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11851))
{var take_cb_11852 = cljs.core.async.impl.protocols.commit.call(null,taker_11851);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11852,taker_11851){
return (function (){return take_cb_11852.call(null,null);
});})(take_cb_11852,taker_11851))
);
} else
{}
{
