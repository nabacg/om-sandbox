...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11842 = 0;while(true){
var m_11843 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11843 == null))
{} else
{m_11843.call(null);
if((count_11842 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11844 = (count_11842 + 1);
count_11842 = G__11844;
continue;
}
} else
{}
