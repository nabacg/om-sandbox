...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11807 = 0;while(true){
if((i_11807 < arr.length))
{(arr[i_11807] = null);
{
var G__11808 = (i_11807 + 1);
i_11807 = G__11808;
continue;
}
} else
...
{var i_11814 = (self__.level + 1);while(true){
if((i_11814 <= (new_level + 1)))
{(update[i_11814] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11816 = 0;while(true){
if((i_11816 <= self__.level))
{var links_11817 = (update[i_11816]).forward;if(((links_11817[i_11816]) === x__$1))
{(links_11817[i_11816] = (x__$1.forward[i_11816]));
{
var G__11818 = (i_11816 + 1);
i_11816 = G__11818;
continue;
}
} else
{{
var G__11819 = (i_11816 + 1);
i_11816 = G__11819;
continue;
}
}
